...
<body class="nav-on-header bg-alt">
	...
	<div class="container">
		<form:form method="POST" action="/resumes"
			modelAttribute="seekerFilter">
		...
		<div class="row">
			<c:forEach items="${foundSeekers}" var="seeker">
				...
				<div class="col-sm-12 col-md-6">
					<a class="item-block" href="/resumes/${seeker.userAccountId}">
						<header> <c:if
							test="${seeker.user_account.user_image != null}">
							<img class="resume-avatar"
								src="../img/${seeker.user_account.user_image}"
								alt="">
						</c:if>
						<div class="hgroup">
